import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,e as a}from"./app-559df010.js";const i={},c=a(`<p>从 Objective-C 对象模型来了解一下在 iOS 里面，类是如何被创建以及属性、方法、成员变量等内存是如何分配，来了解运行时的部分内容。</p><h1 id="对象" tabindex="-1"><a class="header-anchor" href="#对象" aria-hidden="true">#</a> 对象</h1><p>在 Objective-C 中，每一个对象都是某个类的实例，在苹果开源的 Runtime 文件中我们发现这样的定义</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">objc_object</span> <span class="token operator">*</span>id<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>关于 <code>objc_object</code> 的定义：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>struct objc_object {
private:
    isa_t isa;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里就看出，为什么 <code>id</code> 类型可以代表所有的对象。</p><h1 id="类" tabindex="-1"><a class="header-anchor" href="#类" aria-hidden="true">#</a> 类</h1><p>描述了对象的属性、方法、成员变量、内存大小等。我们具体来看看类的结构</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">objc_class</span> <span class="token operator">*</span>Class<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>关于 <code>objc_class</code> 的定义：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>struct objc_class : objc_object {
    // Class ISA;
    Class superclass;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="isa" tabindex="-1"><a class="header-anchor" href="#isa" aria-hidden="true">#</a> isa</h2><p>通常的，我们经常简单的理解 <code>isa</code> 是对象指向自己类的一个指针，每个类又指向自己对应的元类。这里涉及一些方法调用相关知识，这里先不赘述。下面的图大致描述了类之间 <code>isa</code> 指针的关系。</p><figure><img src="https://image-1257141638.cos.ap-guangzhou.myqcloud.com/post/class-meta-relative.jpg" alt="relation of class" tabindex="0" loading="lazy"><figcaption>relation of class</figcaption></figure><p><code>isa</code> 本质上是结构体 <code>isa_t</code> 定义如下：（针对 <code>__x86_64__</code> 架构下的定义）</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">union</span> <span class="token class-name">isa_t</span> 
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到 <code>isa_t</code> 是一个 <code>union</code> 意味着 <code>isa_t</code>、 <code>cls</code>、<code>bits</code> 以及下面的结构体共用一块地址空间，总空间大小会占据 64 位地址空间。（结构体所占用空间最大）</p><figure><img src="https://image-1257141638.cos.ap-guangzhou.myqcloud.com/post/isa_t_s.png" alt="relation of class" tabindex="0" loading="lazy"><figcaption>relation of class</figcaption></figure><h2 id="isa-初始化" tabindex="-1"><a class="header-anchor" href="#isa-初始化" aria-hidden="true">#</a> <code>isa</code> 初始化</h2><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>// initIsa() should be used to init the isa of new objects only.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="indexed-和-magic" tabindex="-1"><a class="header-anchor" href="#indexed-和-magic" aria-hidden="true">#</a> <code>indexed</code> 和 <code>magic</code></h3><p>方法参数中 <code>indexed</code> 其实表示的是 <code>isa_t</code> 的类型，表示是否是指针型 <code>isa</code> 。当 <code>indexed</code> 为 <code>false</code> 时表示为指针型 <code>isa</code> 那么此时访问它的时返回的是 <code>cls</code> 的地址，即类的地址。</p><p>当 <code>indexed</code> 为 <code>true</code> 则是表示不是指针，不过包含了一些 <code>cls</code> 的信息。具体初始化我们看到为：</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>isa<span class="token punctuation">.</span>bits <span class="token operator">=</span> ISA_MAGIC_VALUE<span class="token punctuation">;</span>  <span class="token comment">// ISA_MAGIC_VALUE = 0x001d800000000001ULL</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面我们看到用结构体代替了原来的 <code>isa</code> 指针指向的类地址，这里就提供一个方法来获取 <code>cls</code> 地址。</p><h2 id="cache" tabindex="-1"><a class="header-anchor" href="#cache" aria-hidden="true">#</a> cache</h2><p><code>cache</code> 主要用于方法性能优化，都知道OC里面发消息都需要去方法表里面去查询，当方法很多，又存在继承关系的时候，方法的查询是很费时的，所以这里做了一个对方法进行缓存。下面看一下 <code>cache_t</code> 的定义：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>typedef uint32_t mask_t;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到当我们调用 <code>Method class_getInstanceMethod(Class cls, SEL sel)</code> 如果此时缓存为空，则将 <code>IMP</code> 根据 <code>SEL</code> 缓存起来。</p><p>方法查询的过程的代码片段：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>curClass = cls;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过 <code>sel</code> 找到对应的 <code>key</code> 然后通过 <code>key</code> 找到对应的 <code>bucket</code> 然后保存 <code>key</code> 、<code>imp</code> 。</p><h2 id="bits" tabindex="-1"><a class="header-anchor" href="#bits" aria-hidden="true">#</a> bits</h2><p>这个字段主要是来获取一个类型为 <code>class_rw_t </code> 值的指针。可以很直观的看出，这里保存了类的方法、属性，以及遵循的协议。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>struct class_rw_t {
    uint32_t flags;
    uint32_t version;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中有个常量指针 <code>ro</code> ，里面保存了在编译期就确定的属性、方法和协议。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>struct class_ro_t {
    uint32_t flags;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 Runtime 下执行下面的方法：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>/***********************************************************************
* realizeClass
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>初始化的时候，先调用 <code>data()</code> 方法返回一个类型为 <code>class_rw_t</code> 强转为 <code>class_ro_t</code> 的指针，然后初始化一个 <code>class_rw_t</code> 然后将设置 <code>ro</code> ，以及相关 <code>flag</code> ，最后调用 <code>setData</code> 替换原来的。</p><p>在 <code>static Class realizeClass(Class cls)</code> 方法下面还有对类的方法的一些处理：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>// Attach categories
methodizeClass(cls);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将类原始的方法、属性、协议添加到 <code>class_rw_t</code> 中，然后将分类中的方法也添加到 <code>class_rw_t</code> 方法列表中。而我们可以看到 <code>class_ro_t</code> 中 <code> const ivar_list_t * ivars;</code> 实例变量已经在编译期确定内存地址作为静态变量保存起来了，这也是为什么不能向编译后的类添加实例变量的原因。</p>`,59),l=[c];function d(t,r){return n(),e("div",null,l)}const u=s(i,[["render",d],["__file","2018-07-05-Objective-c对象模型.html.vue"]]);export{u as default};
