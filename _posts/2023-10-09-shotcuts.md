...
![Example for getting a file](/assets/images/8pkqsnjmfw90nds9hr0mspwyss09x6gs.png)
_获取文件方式_
...
![Example for creating a file](/assets/images/27apbrq22k5ndzb42jhsh3v1qtkd2w2w.png)
_添加文件方式_
![Example for updating a file](/assets/images/fexv4g16t5v5c56mxmfqa6cef5s6anbd.png)
_更新文件方式_
...
![碎碎念发布快捷指令](/assets/images/hv6fg6btk8q78qmsk0ymhgxxp0k6z5sa.jpeg){: w="200" .shadow}
_碎碎念发布快捷指令_
...
![实现](/assets/images/rbmbtdq5kt5y4wtawkkqpqeqe2nv3x10.png)
